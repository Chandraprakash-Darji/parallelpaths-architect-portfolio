  ...
  return (
    <main className="relative min-h-screen flex items-center pt-24 lg:pt-0 overflow-hidden">
      ...
      <div className="max-w-[1920px] mx-auto w-full px-6 md:px-12 flex flex-col lg:flex-row items-center gap-12 lg:gap-0">
        {/* Left: Headline */}
        <div className="w-full lg:w-1/2 flex flex-col items-start z-10 pb-12 lg:pb-0 pt-4 lg:pt-0">
          <div className="space-y-0">
            <motion.h1
              initial={{ opacity: 0, y: 40 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, ease: customEase }}
              className="font-headline font-extrabold text-[12vw] sm:text-[10vw] lg:text-[120px] leading-[0.85] tracking-tight uppercase text-primary-text"
            >
              Wilderness<br />
        ...
        <div className="relative w-full lg:w-1/2 flex flex-col lg:flex-row items-center justify-center lg:h-screen lg:overflow-visible">
          ...
          <div className="absolute left-0 bottom-20 flex-col items-center gap-4 hidden lg:flex" aria-hidden="true">
